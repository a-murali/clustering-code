...
for prompt_id in prompts:
    ...
    for i in range(2):
        ...
        hidden_state_last_token = convert_hidden_states[0].shape()#[:][:][:][-1]
        print(type(hidden_state_last_token))
        print(len(hidden_state_last_token))
        print(len(hidden_state_last_token[0]))
        print(len(hidden_state_last_token[0][0]))
        print(len(hidden_state_last_token[0][0][0]))
        print(len(hidden_state_last_token[0][0][0][0]))
        
        
        
        
        data.append([prompts[prompt_id], generated_story, hidden_state_last_token, np.array(output_id)])
